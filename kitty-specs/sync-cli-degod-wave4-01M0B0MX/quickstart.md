...
```bash
SPEC_KITTY_SAAS_SYNC=1 PWHEADLESS=1 SPEC_KITTY_SYNC_DISABLE=1 .venv/bin/python -m pytest \
...
SPEC_KITTY_SAAS_SYNC=1 PWHEADLESS=1 .venv/bin/python -m pytest tests/characterization/test_sync_*.py -q -p no:cacheprovider
