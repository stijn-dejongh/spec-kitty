...
branch_strategy: "Planning artifacts were generated on spec/upgrade-atomicity-recovery; completed changes must merge back into spec/upgrade-atomicity-recovery."
subtasks:
  - "T001"
  - "T002"
phase: "Phase 1 - Setup"
