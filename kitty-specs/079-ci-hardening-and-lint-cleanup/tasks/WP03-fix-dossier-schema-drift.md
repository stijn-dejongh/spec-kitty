...
- 2026-04-09T15:48:57Z – opencode – shell_pid=40632 – DEFERRED ITEMS (post-WP03 review): (1) F401 unused pytest import in test_snapshot.py needs removal. (2) pyproject.toml follow_imports=skip override for specify_cli.* is overly broad - should be narrowed or removed once dossier tests move. (3) src/specify_cli/dossier/tests/ should be relocated to tests/dossier/ to match project test layout convention.
