...
branch_strategy: "Planning artifacts were generated on tidy/ci-docs-charter-path-and-arch-adversarial-shard; completed changes must merge back into tidy/ci-docs-charter-path-and-arch-adversarial-shard."
subtasks:
  - "T001"
  - "T002"
phase: "Phase 1 - Setup"
