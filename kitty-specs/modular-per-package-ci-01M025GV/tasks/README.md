...
branch_strategy: "Planning artifacts were generated on mission/modular-per-package-ci; completed changes must merge back into mission/modular-per-package-ci."
subtasks:
  - "T001"
  - "T002"
phase: "Phase 1 - Setup"
