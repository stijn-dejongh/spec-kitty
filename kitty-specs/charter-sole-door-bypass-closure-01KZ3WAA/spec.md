...
- **SC-007**: The unified builder (covering the two named builder functions plus the `org_layer.py`/
  `generate.py` inline pattern) proves identical output for the 3 kinds gated before FR-005, extended to all
  9 once FR-005 lands — not claimed as a single one-shot proof before FR-005 exists.
