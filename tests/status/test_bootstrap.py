...
def _write_event(mission_dir: Path, wp_id: str, mission_slug: str = "test-feature") -> None:
...
class TestBootstrapSeedsUninitialized:
    ...
    def test_three_new_wps(self, tmp_path: Path) -> None:
        mission_dir = tmp_path / "kitty-specs" / "060-test-feature"
        ...
        result = bootstrap_canonical_state(mission_dir, "060-test-feature")
    ...
    def test_wp_details_report(self, tmp_path: Path) -> None:
        mission_dir = tmp_path / "kitty-specs" / "060-test"
        tasks_dir = mission_dir / "tasks"
        tasks_dir.mkdir(parents=True)
        ...
        result = bootstrap_canonical_state(mission_dir, "060-test")
...
class TestBootstrapSkipsInitialized:
    ...
    def test_one_existing_one_new(self, tmp_path: Path) -> None:
        ...
        _write_event(mission_dir, "WP01", "060-test-feature")
    ...
    def test_all_already_initialized(self, tmp_path: Path) -> None:
        ...
        _write_event(mission_dir, "WP01", "060-test")
        _write_event(mission_dir, "WP02", "060-test")
...
class TestBootstrapDryRun:
    ...
    def test_dry_run_no_events(self, tmp_path: Path) -> None:
        ...
        result = bootstrap_canonical_state(mission_dir, "060-test", dry_run=True)
