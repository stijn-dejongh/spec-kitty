...
class TestArtifactKindValues:
    def test_all_expected_members_present(self) -> None:
        expected = {
            ...
            "paradigm", "procedure", "agent_profile",
            "mission_step_contract", "template",
        }
...
class TestDerivedConstants:
    ...
    def test_ref_type_map_includes_paradigm(self) -> None:
        from specify_cli.constitution.reference_resolver import _REF_TYPE_MAP
...
class TestPydanticIntegration:
    ...
    def test_tactic_reference_deserializes(self) -> None:
        ...
        ref = TacticReference.model_validate(
            {"name": "foo", "type": "styleguide", "id": "sg-01", "when": "always"}
        )
