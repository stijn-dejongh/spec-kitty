...
class TestMiddlewareProcess:
    ...
    def test_process_with_metadata_hints(self):
        ...
        metadata_terms = [
            t for t in result.extracted_terms if t.source == "metadata_hint"
        ]
    ...
    def test_process_deduplicates_terms(self):
        ...
        workspace_terms = [
            t for t in result.extracted_terms if t.surface == "workspace"
        ]
...
class TestSemanticCheckMiddleware:
    ...
    def test_middleware_initialization_default(
...
class TestSemanticCheckIntegration:
    ...
    def test_full_pipeline_with_conflicts(self, semantic_check_store: GlossaryStore):
        ...
        assert (
            ConflictType.AMBIGUOUS in conflict_types
            or ConflictType.UNKNOWN in conflict_types
        )
    ...
    def test_middleware_all_four_conflict_types(
        ...
        context = MockContext(
            ...
            extracted_terms=[
                ...
                ExtractedTerm(
                    "critical_unknown", "quoted_phrase", 0.3, "critical_unknown"
                ),
            ],
        )
        context.conflicts = []
