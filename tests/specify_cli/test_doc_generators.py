...
def test_jsdoc_configure_creates_config(tmp_path):
    ...
    config_file = generator.configure(
        tmp_path,
        {"project_name": "Test Project", "description": "Test", "version": "1.0.0"},
    )
...
def test_sphinx_configure_creates_conf_py(tmp_path):
    ...
    config_file = generator.configure(
        tmp_path,
        {"project_name": "Test Project", "author": "Test Author", "version": "1.0.0"},
    )
...
''')
    ...
    generator = SphinxGenerator()
    config_file = generator.configure(
        docs_dir, {"project_name": "Test", "author": "Test Author", "version": "0.1.0"}
    )
