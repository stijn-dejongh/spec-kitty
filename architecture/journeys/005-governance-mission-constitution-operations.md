...
| **Related Spec / ADR** | [`kitty-specs/047-agent-profile-domain-model/spec.md`](../../kitty-specs/047-agent-profile-domain-model/spec.md) |
...
|---|----------------------------|----------|-------------|-------------------------------------------------------------------|
| 1 | Maintainer                 | `human`  | N/A         | Defines governance outcome and approves changes                   |
| 2 | codex generic: kitty-aware | `llm`    | implementer | Executes curation, updates artifacts, and reports outcomes        |
| 3 | Spec Kitty CLI             | `system` | N/A         | Validates commands, updates constitution extracts, reports status |
