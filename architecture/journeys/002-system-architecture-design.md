...
## Relationship to Design Mission Analysis

This journey captures the **user experience** of architectural design. The
[design mission analysis](../../tmp/doctrine-missions/design-mission-analysis.md)
captures the **system implementation** — how to add a `design` mission type to the
...
- The analysis answers: **How does spec-kitty implement it?**
