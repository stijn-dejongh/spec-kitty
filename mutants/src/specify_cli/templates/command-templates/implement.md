...
If the prompt shows `review_status: "has_feedback"`, read frontmatter `review_feedback` first. The `feedback://...` pointer is the canonical reviewer feedback artifact.
