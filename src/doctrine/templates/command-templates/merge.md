...
scripts:
  sh: "spec-kitty merge --mission <mission-slug>"
  ps: "spec-kitty agent"
---
...
- Do **not** manually run `git merge <mission-WP##>` loops.
...
- Workspace-per-WP missions are merged using ancestry-aware pruning.
