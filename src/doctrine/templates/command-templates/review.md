...
- **Approved**:
  - Append Activity Log entry capturing approval details (capture shell PID via `echo $$` or helper script, e.g., `2025-11-11T13:45:00Z – claude – shell_pid=1234 – Approved without changes`).
  - Update frontmatter:
    - Sets `lane: "done"`
